...
CreateNewSection($scope) {
  ...
  var innerhtml_div =  '<div id="sectiondiv" class="modules-brief" ng-show = "IsVisible"><div><input type="text" name="add_section" formControlName="add_section" placeholder="Add Section*" class="form-control"/></div><br/><section><button (ng-click)="CreateNewSubSection()">New SubSection</button></section>'
...
CreateNewSubSection($scope) {
  // get_section_id.hidden = get_section_id.hidden ? false : true;
  // background-color: #d7e1e2;
  var innerhtml_div =  '<div id="subsectiondiv" class="modules-brief" ng-show = "IsVisible"><div><input type="text" name="add_sub_section" formControlName="add_sub_section" placeholder="Add Sub Section*" class="form-control"/></div><br/><section><button (ng-click)="CreateNewUnit()">New Unit</button></section></div>'
  console.log("CreateNewSubSectionCreateNewSubSection###################", $scope);
